...
```
src/
├─ app/            # Expo Router: (tabs)/ — Лента · Подписки · Карта · Профиль
...
свайповая лента мастер-классов, подписки и страницы хореографов,
нативная карта, preview-досье и красная нитка, досье события, выбор сессии,
booking RPC, «Мои записи», поиск и фильтры.
